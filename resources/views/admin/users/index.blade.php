            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-800 text-white text-left">
                        ...
                        <th class="p-3">NIS / ID Petugas</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3">{{ $user->nis ?? $user->staff_id ?? '-' }}</td>
                    ...
                    @empty
                    <tr><td colspan="6" class="p-4 text-center text-gray-500">Tidak ada user yang terdaftar.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
